...
namespace Aurora.Settings
{
	...
	public class FreeFormObject
	{
		...
		/// <summary>
		/// Creates an instance of the FreeFormObject from Rectangle.
		/// </summary>
		/// <param name="rectangle">The rectangle that represents region</param>
		public FreeFormObject(RectangleF rectangle) : 
